...
function Install()
{
  ...
  URLKernel='https://github.com/klever1988/lotServer/raw/master/lotServer.log'
  ...
  mkdir -p "${AcceTmp}/bin/"
  mkdir -p "${AcceTmp}/etc/"
  wget --no-check-certificate -qO "${AcceTmp}/bin/${AcceBin}" "https://github.com/klever1988/lotServer/raw/master/${MyKernel}"
  ...
  wget --no-check-certificate https://github.com/klever1988/LotServer_KeyGen/archive/refs/heads/master.zip && rm -rf /tmp/LotServer_KeyGen-master && unzip master.zip
  ...
  bash "${AcceRoot}/install.sh" -r -i ${Eth}
